...
export const Header: React.FC = () => {
  ...
  return (
    <header 
      className="absolute md:fixed top-0 left-0 right-0 z-50 flex items-start justify-between px-4 pt-4 pb-2 md:items-center md:px-10 md:py-4 backdrop-blur-md bg-[linear-gradient(180deg,#0E0E0F_39.81%,rgba(14,14,15,0)_100%)] md:bg-[#0E0E0F]/95 md:border-b md:border-[#292a2a]/50"
      style={{ width: "100%" }}
    >
      {/* Logo */}
      ...
      {/* Mobile menu overlay */}
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-50 bg-[#0e0e0f]">
          <div className="relative w-full h-full px-6 pb-8 pt-0 flex flex-col items-center justify-between bg-[#0E0E0F]">
            <div className="absolute top-0 left-0 w-full px-4 pt-4 pb-2 flex justify-between items-start bg-[linear-gradient(180deg,#0E0E0F_39.81%,rgba(14,14,15,0)_100%)]">
              <Link to="/" className="flex items-center gap-1">
                <img src={logoImg} alt="Chip1 Logo" className="h-10 w-auto" />
              </Link>
              <button
                type="button"
                className="w-10 h-10 rounded-full bg-[#17181a] text-[#99C221] flex items-center justify-center"
            ...
            <nav className="mt-24 w-full flex flex-col gap-6">

  ...
  return (
    <section className="bg-[#0e0e0f] py-10 md:py-16 mb-6 md:mb-[120px]">
      <div className="max-w-[1280px] mx-auto px-4 md:px-[80px]">
        <h2
          className="text-[24px] md:text-5xl font-semibold text-[#efeff0] text-left mb-4 md:mb-16 md:uppercase"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          {contactInfo.map((info, index) => (
            <div key={index} className="flex flex-col items-start gap-2">
              <p
                className="text-[#99c221] text-[24px] md:text-[40px] font-semibold md:uppercase"
                style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}
              >
                {info.region}
              </p>
              <p className="text-[#cececf] text-[20px] md:text-lg">{info.phone}</p>
            </div>
          ))}
        </div>
      </div>

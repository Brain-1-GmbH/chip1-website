...
export const SellExcessSection: React.FC = () => {
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex gap-10 flex-wrap">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                {formData.sellingTypes.lineSales && <Checkmark size={12} className="text-[#0e0e0f]" />}
              </button>
            ...
            <div className="flex items-center gap-2">
              ...
              >
                {formData.sellingTypes.lotSales && <Checkmark size={12} className="text-[#0e0e0f]" />}
              </button>
              <span className="text-base text-[#e5e5e7]" style={{ fontFamily: "Inter, sans-serif" }}>
                Lot Sales
              </span>
            ...
            <div className="flex items-center gap-2">
              ...
              >
                {formData.sellingTypes.consignmentSales && <Checkmark size={12} className="text-[#0e0e0f]" />}
              </button>
              <span className="text-base text-[#e5e5e7]" style={{ fontFamily: "Inter, sans-serif" }}>
                Consignment Sales
              </span>
  ...
  const renderStep3 = () => (
    <>
      ...
      {/* Sign Up Link - Mobile only, centered */}
      <div className="md:hidden flex items-center justify-center gap-4" style={{ marginTop: "-72px" }}>
    ...
    <section className="pt-[64px] md:pt-[90px] px-4 md:px-[60px] pb-0">
      <div className="max-w-[1440px] mx-auto flex flex-col md:flex-row items-start min-h-[calc(100vh-64px)] md:min-h-[720px]">
        ...
        <div className="w-full md:w-[42%] bg-[#0e0e0f] pt-6 md:pt-10 px-0 md:px-10 h-full flex flex-col">
          <div className={`flex flex-col gap-10 h-full ${currentStep === 2 || currentStep === 3 ? 'pb-24 md:pb-0' : 'pb-24 md:pb-0'}`}>

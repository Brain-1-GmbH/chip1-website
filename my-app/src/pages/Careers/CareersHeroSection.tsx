...
import careersHeroBg from "../../assets/careers-hero.png";
  ...
  return (
    <div className="relative w-full h-[440px] md:h-[700px] flex items-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col gap-4 items-start w-full max-w-[1280px] mx-auto px-4 pt-[160px] md:px-[80px] md:pt-[200px]">
        ...
        {/* Title */}
        <h1
          className="text-[32px] md:text-[56px] font-semibold leading-[1.2] md:leading-[1.1] max-w-[863px] text-white"
          style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}
        >
          Where Talent Fuels Innovation
        </h1>
        ...
        <p
          ...
          style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}
        >
          Join a Legacy of Leadership and Creativity
        </p>
      </div>
    </div>
  );
